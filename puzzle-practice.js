import { ROWS, COLS, RED, BLACK, legalMoves, applyMove, name, notation } from './game.js?v=be7ce20871';
import { validatePuzzle, isCheckmateAfterSolution } from './puzzle-domain.js?v=be7ce20871';
