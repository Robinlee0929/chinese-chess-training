import { ROWS, COLS, RED, BLACK, legalMoves, applyMove, name, notation } from './game.js?v=b35d58d934';
import { validatePuzzle, isCheckmateAfterSolution } from './puzzle-domain.js?v=b35d58d934';
