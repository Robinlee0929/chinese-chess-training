import { ROWS, COLS, RED, BLACK, legalMoves, applyMove, name, notation } from './game.js?v=58273955d5';
import { validatePuzzle, isCheckmateAfterSolution } from './puzzle-domain.js?v=58273955d5';
