import { ROWS, COLS, RED, BLACK, legalMoves, applyMove, name, notation } from './game.js?v=79cf894baf';
import { validatePuzzle, isCheckmateAfterSolution } from './puzzle-domain.js?v=79cf894baf';
