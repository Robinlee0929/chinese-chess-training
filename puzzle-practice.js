import { ROWS, COLS, RED, BLACK, legalMoves, applyMove, name, notation } from './game.js?v=51be239e94';
import { validatePuzzle, isCheckmateAfterSolution } from './puzzle-domain.js?v=51be239e94';
