import { ROWS, COLS, RED, BLACK, legalMoves, applyMove, name, notation } from './game.js?v=c5216ea920';
import { validatePuzzle, isCheckmateAfterSolution } from './puzzle-domain.js?v=c5216ea920';
