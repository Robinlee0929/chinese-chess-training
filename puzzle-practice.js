import { ROWS, COLS, RED, BLACK, legalMoves, applyMove, name, notation } from './game.js?v=16f0f90eac';
import { validatePuzzle, isCheckmateAfterSolution } from './puzzle-domain.js?v=16f0f90eac';
