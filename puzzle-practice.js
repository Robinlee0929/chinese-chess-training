import { ROWS, COLS, RED, BLACK, legalMoves, applyMove, name, notation } from './game.js?v=88be8103f4';
import { validatePuzzle, isCheckmateAfterSolution } from './puzzle-domain.js?v=88be8103f4';
