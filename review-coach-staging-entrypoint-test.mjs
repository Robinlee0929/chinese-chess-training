...
function fakeDocument(mainSource = './main.js?v=406217217c') {
  return {
...
async function importStagingBootstrap(candidate) {
  const dependencyTarget = "} from '../review-coach-staging-bootstrap.js?v=406217217c';";
  const dependencyUrl = new URL(
    './review-coach-staging-bootstrap.js?v=406217217c', import.meta.url,
  ).href;
...
test('staging capability is branded and installed before main initialization', async () => {
  ...
  assert.equal(mainUrl, 'https://robinlee0929.github.io/chinese-chess-training/main.js?v=406217217c');
